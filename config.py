...
app.config['SITE_NAME'] = "灰礁播客"  # 改站点想要的名称
app.config['SITE_DESCRIPTION'] = "浮筝带来的灰礁上的声音"  # 改站点描述
db = SQLAlchemy(app)
...
def upload():
    ...
    return render_template('upload.html')  # 注意这里使用uploads.html而不是upload.html
